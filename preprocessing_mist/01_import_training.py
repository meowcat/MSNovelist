...
import itertools
import uuid
import fp_management.fingerprinting as fpr_

import fp_management.fingerprint_map as fpm
import smiles_config as sc
import pickle
db_crossval = "~/msmsgym/msnovelist-data/msnovelist_crossval.hdf5"
db_train = "~/msmsgym/msnovelist-data/msnovelist_train.hdf5"

# db_old = "/sirius6_db/combined_0824_v44.db"
db_uuid = uuid.uuid4()
db_new = f"~/msmsgym/msnovelist-data/mist-{db_uuid}.db"
